<x-slot name="header">
   ...
   <h2 class="font-semibold text-xl text-gray-800 leading-tight">
           Manage ecoles (Laravel 8 Jetstream Livewire CRUD App Example - NiceSnippets.com)
       </h2>
   </h2>
   </x-slot>
   ...
   <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Create New ECol</button>
               @if($isOpen)
