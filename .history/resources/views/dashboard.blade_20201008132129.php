    ...
    <x-slot name="header">
        <div class="container-fluid home-content1">
            <div id="home_quicklinks">
                <a class="quicklink link1" href="{{ route('register-parents') }}">
        ...
        <div class="container-fluid home-content2">
            <p><span>Malick Coly</span>, je suis <span>Etudiant</span> en <span>Mathematiques Appliques</span> et <span>Developpeur Web et Mobile</span>. Cette application est pour la <span>Gestion</span> d'un <span>Ecole</span>.</p>
        </div>
    </x-slot>
