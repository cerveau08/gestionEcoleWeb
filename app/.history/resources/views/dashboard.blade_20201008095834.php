...
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="container-fluid home-content2">
            <p><span>Malick Coly</span> je suis <span>Etudiant en Mathematiques Appliques</span> et <span>Developpeur </span>, including new <span>releases</span> and <span>Bootstrap Themes</span>.</p>
        </div>
    </x-slot>
