...
<nav x-data="{ open: false }" class="navbar navbar-expand navbar-dark bg-dark">
    <a href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="navbar-brand">Gestion d'Ecole</a>
    

    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <a href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="nav-item active nav-link">Module</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <a href="#" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">Nossa história</a>
            </div>
