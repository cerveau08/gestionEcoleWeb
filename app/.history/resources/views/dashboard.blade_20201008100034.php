...
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="container-fluid home-content2">
            <p><span>Malick Coly</span>, je suis <span>Etudiant</ en Mathematiques Appliques</span> et <span>Developpeur Web et Mobile</span>. Cette application est pour la<span>Gestion</span> d'un <span>Ecole</span>.</p>
        </div>
    </x-slot>
