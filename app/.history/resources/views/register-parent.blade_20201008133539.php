        ...
        <div class="container register-form top-buffer-1">
            <div class="form">
                ...
                <div class="form-content bk">
                    <form method="post" action="{{ route('register-parents') }}" id="login-form" class="form">
                        @csrf
                                ...
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" class="form-control" formControlName="profession" id="profession" placeholder="profession" name="pasword">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                        </fieldset>
                        <button type="submit" class="btn btn-primary" value="submit">Creer Compte Parent</button>
                     </form>
                </div>
            </div>
        </div>
