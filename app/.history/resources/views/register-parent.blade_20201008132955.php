                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row" formGroupName="partenaire">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="lastName" class="form-control" id="lastName" placeholder="Nom Complet" name="lastName">
                                </div>
                                <div class="col-sm-3">
                                    <label for="email">Registre De Commeemaile</label>
                                    <input type="email" class="form-control" id="email" placeholder="Registre De Commeemaile" name="email">
                                </div>
                                <div class="col-sm-3">
