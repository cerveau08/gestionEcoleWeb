...
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="container-fluid home-content2">
            <p><span>Malick Coly</span> je suis <span>announcements</span> for all things <span>Bootstrap</span>, including new <span>releases</span> and <span>Bootstrap Themes</span>.</p>
        </div>
    </x-slot>
