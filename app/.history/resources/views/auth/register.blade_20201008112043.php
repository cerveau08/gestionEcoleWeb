                        ...
                        <div id="login-box" class="col-md-12">
                            <form method="POST" action="{{ route('register') }}" id="login-form" class="form" >
                                ...
                                <div class="form-group">
                                    <x-jet-label class="text-info" value="{{ __('FirtName') }}" />
                                    <x-jet-input class="form-control" type="text" name="fisrtName" :value="old('firstName')" required autofocus autocomplete="firstName" />
                                </div>

                                <div class="form-group">
                                    <x-jet-label class="text-info" value="{{ __('FisrtName') }}" />
                                    <x-jet-input class="form-control" type="text" name="fisrtName" :value="old('firstName')" required autofocus autocomplete="firstName" />
                                </div>
