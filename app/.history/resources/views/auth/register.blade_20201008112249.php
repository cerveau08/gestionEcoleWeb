                        ...
                        <div id="login-box" class="col-md-12">
                            <form method="POST" action="{{ route('register') }}" id="login-form" class="form" >
                                ...
                                <div class="form-group">
                                    ...
                                    <x-jet-input class="form-control" type="text" name="adresse" :value="old('adresse')" required autofocus autocomplete="adresse" />
                                </div>

                                <div class="form-group">
                                    <x-jet-label class="text-info" value="{{ __('Tele') }}" />
                                    <x-jet-input class="form-control" type="text" name="Tele" :value="old('Tele')" required autofocus autocomplete="Tele" />
                                </div>
