...
Route::post('register-parent-', [InscriptionController::class, 'registerParent'])->name('register-parent');
Route::post('students-list', [InscriptionController::class, 'listStudent'])->name('students-list');
