...
class InscriptionController extends Controller
{
    public function registerParent(Request $request)
    {
        ...
        return redirect()->route('inscription')->with('success','L\'inscrption s\'est bien passe .');
    }
    ...
    public function inscrire(Request $request) {
        ...
        return redirect()->route('students-listlist')->with('success','Post created successfully.');
    }
}
