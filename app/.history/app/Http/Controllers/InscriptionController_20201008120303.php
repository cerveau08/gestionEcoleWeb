...
class InscriptionController extends Controller
{
    public function registerParent(Request $request)
    {
        ...
        return redirect()->route('inscription')->with('success','L\'enregistrement, s\'est bien passe .');
    }
    ...
    public function inscrire(Request $request) {
        ...
        return redirect()->route('students-list')->with('success','L\'inscrption s\'est bien passe .');
    }

    public function listStudent() {
        $posts = User::all();

        return view('students-list', compact('posts'));
    }
}
